...
![Project management triangle showing the relationship between scope, cost, and time, and how it affects the quality of a project.](https://images.ctfassets.net/wp1lcwdav1p1/3sikXnjGY7TKG7CudZ6LaM/80234138d39b4343f3e490e8fad23e65/GOEdQk1-T6ehHUJNfo-n-A_0cfb775c91ec44c39b72066d3de29bf1_triple-constraint.png?w=1500&q=60)

Some models show an enhanced project management “triangle” with six constraints [[1](https://www.pmi.org/learning/library/six-constraints-enhanced-model-project-control-7294)]:
1. Scope
2. Cost
3. Time
...
The project management triangle is a useful concept for [project managers](https://www.coursera.org/articles/what-is-project-manager). It offers several benefits, including:
...
[Speak with stakeholders](https://www.coursera.org/articles/stakeholder-management) to determine what constitutes an acceptable change and which constraints you should prioritize. Is the deadline immovable or the budget strict? This will give you an idea of how the project can adapt should changes become necessary. This is a crucial step in the initial stages of the project, but frequent communication should also happen throughout the project.

## Establish risk management processes.
Planning for risks should be a step baked into your project management process to prevent [scope creep](https://www.coursera.org/articles/what-is-scope-creep) and stay within budget and on schedule. Identify risks, then establish a plan to mitigate each. If you’re looking for more detail, read about [how to manage project risks](https://www.coursera.org/articles/how-to-manage-project-risk).

## Create change management processes.
Change is often inevitable. Having a [change management](https://www.coursera.org/articles/change-management) process in place creates a structured way to approve or reject changes. This ensures the team is aware of changes as they happen and how they impact the project. This can also reduce scope creep.

## Choose a methodology based on constraints.
You might opt to adopt a [project management methodology](https://www.coursera.org/articles/types-of-project-management) based on the constraints you face. Often, you can manage projects that face strict constraints with a Waterfall-type approach. If you need more flexibility, an [Agile method like Scrum](https://www.coursera.org/articles/agile-vs-scrum) might be more fitting. Projects where you need to minimize inefficiencies as much as possible can benefit from a Lean approach.

## Use project management software.
Having the right [tools in project management](https://www.coursera.org/articles/project-management-methodologies-your-guide) can help you manage the three constraints by improving visibility, encouraging stakeholder communication, managing resources, scheduling and assigning tasks, and sending project alerts.
...
**Read more:** [AI Project Management Tools: Exploring the Future of Efficiency](https://www.coursera.org/articles/ai-project-management-tools)