---
{"dg-publish":true,"permalink":"/03-erazmus/03-02-economics/creating-a-strategy-map/","tags":["erasmus","eraECO","madeByAI"],"dg-note-properties":{"Date":"2026-02-18","Class":"Economics","tags":["erasmus","eraECO","madeByAI"]}}
---

# Translating Objectives into Measures and Targets
- Strategic objectives must be translated into **measures** to eliminate ambiguity.
- Measures clarify exactly how success will be evaluated.
- Example: “On‑time delivery” must be defined precisely (e.g., Toyota requires arrival within one hour of scheduled time).
- Measures help with communication, motivation, feedback, and evaluation.
...
- Shows how improvements in Learning & Growth enable better Processes, which improve Customer outcomes, which drive Financial results.

## Logical sequence
1. **Financial perspective** – long‑run financial objectives (ultimate destination).
2. **Customer perspective** – how the company creates value for targeted customers.
...
- Objectives include:
    ...
    - Lower cost, higher quality, shorter cycle times
