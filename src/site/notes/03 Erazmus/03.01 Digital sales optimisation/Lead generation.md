---
{"dg-publish":true,"permalink":"/03-erazmus/03-01-digital-sales-optimisation/lead-generation/","tags":["erasmus","eraDSO"],"dg-note-properties":{"Date":"2026-05-08","Class":"Digital Sales Optimisation","tags":["erasmus","eraDSO"]}}
---

It is the bridge between attention and sales. It turns anonymous audiences into identifiable prospects.

**Lead generation** is the process of attracting people interested in a product/service and encouraging them to share some form of contact information or behavioural signal (*e.g. an email address, phone number, account signup, demo request, webinar registration*)

A **lead** is not a customer yet. A lead is someone who has shown potential buying interest

# 3 types of leads
1. A **qualified lead** is a prospect who has demonstrated a genuine interest in a product/service and is more likely to convert
2. A **warm lead** falls between these two – they’ve expressed some interest, but it’s up to sales to follow up and determine if the lead can become qualified.
3. An **unqualified lead** lacks the necessary interest level to become a customer.

# Why LG matters
Digital marketing often begins with visibility
- Ads
- SEO
- Social media
- Influencers
...
>[!example]+
>A **TikTok video** may get **500 000 views**, but unless the company can move some viewers into a relationship the business may be **weak**

Lead generation matters because it helps companies
- Build a database of potential customers
- Nurture people over time
- Measure marketing effectiveness
- Support the sales team
- Reduce dependence on one-off advertising
...
## Landing page
- A focused web page dedicated for one conversion goal

>[!example]+
>A fitness brand runs an ad: "*Download our new free 7-day home workout plan -> the user clicks -> enters an email address -> receives the plan*"
>
>The company now has a lead

## Lead magnets
- Something valuable offered in exchange for contact information
	- E-books
	- Templates
	- Webinars
	- Free trials
...
- People who search on Google often already have a problem
- It is very powerful, because the person searching has interest in it

>[!example]+
>Someone searches "*Best CRM for small business*".
>
>A software company can run a google ad leading to a comparison guide or free demo signup.
>
>This is powerful because the user has intent.
...
>[!important]+
>Lead generation is not only about forms, it can also be about creating repeat engagement, collecting behavioural signals, and moving users closer to loyalty or conversion

**Viral user-generated content**: the hashtag brought 73.7 billion views on TikTok (*2023*) -> voluntary brand ambassadors

**Massive brand visibility**: generates 2+ billion social media impressions with almost zero traditional advertising spend

**Competitor differentiation**: sets a standard for personalization that competitors (*Apple music, YouTube music, Tidal*)
