...
- **Push**
	- Excess capacity
	- One or more unique products
	- Firm-specific advantages
	- Product development
- **Pull**
	- Receiving an unsolicited order
	- A small or saturated home market
...
- *What differences are there?*
	- End users must be considered in terms of adapting the product or service
	- Production facility may be set up in said country
...
- Several pitfalls
	...
	- Charging premium price for diversification
	- Thinking is narrow, opportunities missed, company is overtaken by competitors
- **Markides** (*1997*) recommends asking:
	- *What can we do better than our competitors?*
	- *Which strategic resource should be used in the new sectors or segments?*
	- *Can we outperform the competition and become a strong player?*
	- *Can the existing business areas be negatively affected?*
	- *What learning potential exists? (Potential for synergy?)*


> [!example]
> **Valve corporation**
> - Started as a company making games
> - Later diversified into reselling of games through their market
> - In recent times they started focusing on hardware too
...
> - Positioned as a “merger of equals”
> 
> **What went wrong**
> - Cultural incompatibility: German engineering-driven, hierarchical culture vs. American cost-focused, decentralized culture.
> - False narrative: It was not a true merger of equals—Daimler dominated decision-making.
> - Operational conflict: Different views on quality, cost control, and innovation.
> 
> **Outcome**
> - Chrysler sold off in 2007 for a fraction of the purchase price.
> 
