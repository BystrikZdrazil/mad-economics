...
- This is only between [[02 Programming/02.02 C-SHARP/Variables\|Variables]] that store the same value type
```C#
...
```
## Complex conversion
- We can convert [[02 Programming/02.02 C-SHARP/Variables\|Variables]] into others even if they use different value types
