---
{"dg-publish":true,"permalink":"/02-programming/02-04-html/most-common-elements/","dg-note-properties":{}}
---
...
## Anchor
- Links
- Require href (HyperText reference) [[02 Programming/02.04 HTML/Attributes in HTML\|Attributes in HTML]], that is the link we want the user to be sent to
```html
...
You can link an input to a label with an ID on the input and a for  [[02 Programming/02.04 HTML/Attributes in HTML\|Attributes in HTML]] on the label. When you click the label it will activate your input.
```html
<form>
	<p>Checkbox</p>
...
- Style flips to CSS
- To keep things organized, this is not much recommended because you can [[02 Programming/02.04 HTML/Link a file\|Link a file]]
```html
<style>
	h1 {
		font-size: 20px;
...
```
# [[02 Programming/02.04 HTML/Container elements\|Container elements]]
